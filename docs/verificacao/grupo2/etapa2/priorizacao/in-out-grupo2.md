...
|---------|---------|---------|-----------|------------------|------|
|Entrega 02|In or Out|`1.0`|Caio Mesquita|Douglas Marinho|10/06|
...
A Tabela 2 a seguir apresenta a verificação do artefato <a href="https://requisitos-de-software.github.io/2024.1-CarteiradeTrabalhoDigital/#/Elicitacao/Priorizacao/Execucao/InOrOut">In or Out</a>  do <a href="https://requisitos-de-software.github.io/2024.1-CarteiradeTrabalhoDigital/">grupo 02</a> por meio de um checklist detalhado. Esta verificação tem como objetivo assegurar que todos os elementos essenciais do artefato estão presentes e bem definidos, garantindo sua qualidade e conformidade com os requisitos estabelecidos.
...
| 12 | Inclui exemplos ou casos de exclusão? |Sim||
| 13 | Os critérios são justificados e explicados? |Incompleto| Critérios abordados apenas em videos não no artefato diretamente|
| 14 | Inclui um processo para revisão e ajuste dos critérios? |Não|Não se tem revisão de forma explicita |
